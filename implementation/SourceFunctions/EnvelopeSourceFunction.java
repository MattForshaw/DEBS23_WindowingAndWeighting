...
public class EnvelopeSourceFunction extends RichParallelSourceFunction<String> {

    private static final Logger logger  = LoggerFactory.getLogger(EnvelopeSourceFunction.class);
    ...
    public EnvelopeSourceFunction(int ampl, double freq, int step, int phase_shift, int vertical_shift, int size) {
		amp = ampl;
		omega = freq;
		H_STEP_SIZE = step;
