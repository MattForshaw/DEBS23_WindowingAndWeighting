...
import ch.ethz.systems.strymon.ds2.flink.wordcount.sources.SineWaveSourceFunction2;
...
public class SineWaveWordCount {

    private static final Logger logger  = LoggerFactory.getLogger(SineWaveWordCount.class);
	...
	public static void main(String[] args) throws Exception {
		...
		// execute program
		env.execute("SineWaveWordCount2");
	}
