...
import ch.ethz.systems.strymon.ds2.flink.wordcount.sources.UniformIncrementSourceFunction;
...
public class UniformIncrementWordCount {

    private static final Logger logger  = LoggerFactory.getLogger(UniformIncrementWordCount.class);
	...
	public static void main(String[] args) throws Exception {
		...
		final DataStream<String> text = env.addSource(
				new UniformIncrementSourceFunction(
						params.getInt("start-rate", 10000),
						params.getInt("time-step", 60),
						params.getInt("increment-size", 1000),
		...
		// execute program
		env.execute("UniformIncrementWordCount");
	}
	...
	public static final class Tokenizer extends RichFlatMapFunction<String, Tuple2<String, Long>> {
		...
		public void open(Configuration parameters) throws Exception {
			...
			this.meter = getRuntimeContext()
			  .getMetricGroup()
			  .meter("myMeterSplit", new DropwizardMeterWrapper(dropwizardMeter));
		}
	...
	public static final class CountWords extends RichFlatMapFunction<Tuple2<String, Long>, Tuple2<String, Long>> {
		...
		public void open(Configuration parameters) throws Exception {
			...
			this.meter = getRuntimeContext()
			  .getMetricGroup()
			  .meter("myMeterCount", new DropwizardMeterWrapper(dropwizardMeter));
